...
//http://localhost:portNo/swagger -ui/index.html //if we type this swagger will work
@Configuration // means configuration that spring boot needs to create a bean and inject into application
@EnableSwagger2
